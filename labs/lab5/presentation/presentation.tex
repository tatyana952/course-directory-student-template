...
\item
  ...
  пользователей, а также влияние битаSticky на запись и удаление
  файлов.1.
\end{itemize}
\end{frame}
...
\tightlist
\item
  Создаю программу simpleid.c: 36 Кулябов Д. С., Королькова А. В.,
  Геворкян М. Н. \#include \textless sys/types.h\textgreater{} \#include
...
\tightlist
\item
  Компилирую программу gcc simpleid.c -o simpleid
\end{enumerate}
\end{frame}
...
\tightlist
\item
  Выполняю программу simpleid: ./simpleid
\item
  Выполняю системную программу id: id и сравниваю полученный вами
  результат с данными предыдущего пункта задания.
\item
  Усложняю программу, добавив вывод действительных идентификатов
\end{enumerate}
\end{frame}
...
root:guest /home/guest/simpleid2 chmod u+s /home/guest/simpleid2
\end{frame}
...
\tightlist
\item
  Использую sudo или повысьте временно свои права с помощью su.
  Поясните, что делают эти команды.
\item
  Выполняю проверку правильности установки новых атрибутов и смены
...
\setcounter{enumi}{10}
\item
  Запускаю simpleid2 и id: ./simpleid2 id Сравняю результаты.
\item
  делаю тоже самое относительно SetGID-бита
\item
